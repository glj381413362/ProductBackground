...
(function(t, i, s) {
	...
	l.prototype = {
		...
		eventBind: function() {
            ...
            $('.ui-slider-btn').get(1).addEventListener('touchstart',function(i){
                if(t.result) {
                    return
                }
                t.slidertouchstart(i)
		...
		slidertouchmove: function(i,e){
            ...
            $('.ui-slider-btn').get(1).addEventListener('touchmove',function(t){
		...
		slidertouchup: function(){
			...
			$('.ui-slider-btn').get(0).addEventListener('touchend',function(t){
                if(i.sliderBtn_left != i.maxLeft) {
                    ...
                    /*验证通过后样式改变--移动端*/
                    $(".ui-slider-btn i").removeClass("rightRow");
                    $(".ui-slider-btn i").addClass("rightRow-right");
                    $(".ui-slider-btn").css({
                        borderLeft: "0"
                    });
            ...
            $('.ui-slider-btn').get(1).addEventListener('touchend',function(t){
                if(i.sliderBtn_left != i.maxLeft) {
                    i.sliderBtn_left = 0
                } else {
                    i.ele.find(".ui-slider-text").text(i.opts.successMsg).css({
