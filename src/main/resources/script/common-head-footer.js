...
//     })
  ...
  if ($("#search-page-height").length != 0) {
    document.getElementById("search-page-height").style.height = screenHeight
        + "px";
  }
  if ($("#allProduct-page-height").length != 0) {
    document.getElementById(
        "allProduct-page-height").style.height = screenHeight + "px";
  }
  ...
  //移动端上面黑色条条如果是没有登陆的情况
  if ($(".sy-logistics-info-row .sy-option-left").length === 0 || $(
      ".sy-option-left").css("display") == "none") {
